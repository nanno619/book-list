...
@section('content')
    ...
    <div class="filter-container mb-4 flex">
        ...
        @foreach ($filters as $key => $label)
            {{-- NOTE: ...request()->query() will unpack this array, it will get every single element 
            from query array and it will add to the resulting array ['filter' => $key] --}}
